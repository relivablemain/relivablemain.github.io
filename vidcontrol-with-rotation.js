AFRAME.registerComponent('vidcontrol', {
    ...
    schema: {
      ...
      videoRotation: {type: 'string', default: ''}
    },
    ...
    init: function () {
     ...
     console.log("videoSRC =" + this.data.videoSRC);
      ...
      this.el.addEventListener('click', () => 
      {
        ...
        var vidrotation = this.el.getAttribute("vidcontrol").vidRotation;

        videoElement.setAttribute("src", this.data.videoSRC);
        videoElement.setAttribute("rotation", vidrotation);
